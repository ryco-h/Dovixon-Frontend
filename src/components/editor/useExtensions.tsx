...
import { FontSize, HeadingWithAnchor, LinkBubbleMenuHandler } from 'mui-tiptap';
...
export default function useExtensions({
	...
	return useMemo(() => {
		return [
			...
			History,
			Highlight.configure({
				multicolor: true, // allows color options
			}),
			Placeholder.configure({
				placeholder,
				emptyEditorClass: 'is-editor-empty', // optional: custom styling hook
			}),
